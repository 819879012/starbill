...
import gui_listener.IncomeHistogramListener;
import util.ChartUtil;
import util.ColorUtil;
import util.GUIUtil;

@SuppressWarnings("serial")
public class IncomeHistogramPanel extends GraphPanel {
 
    private static IncomeHistogramPanel instance = new IncomeHistogramPanel();
    ...
    public IncomeHistogramPanel() {
        this.setLayout(new BorderLayout());
        Image image =ChartUtil.getImage(800, 400,"月收入报表");
	...
	public void addListener() {
		IncomeHistogramListener listener = new IncomeHistogramListener();
		chooseYearButton.addActionListener(listener);
		chooseMonthButton.addActionListener(listener);
		refreshButton.addActionListener(listener);
	}

	public static IncomeHistogramPanel getInstance() {
		return instance;
	}
