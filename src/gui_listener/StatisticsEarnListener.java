...
public class StatisticsEarnListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if( b == panel.getChooseCategory() ) {
			...
			List<IncomeCategory> incomeCategoryList = categoryService.list();//获得costcategory的list
			String[] costCategoryStr = new String[incomeCategoryList.size()] ;//用来存放list中的分类名
